...
WSGI_APPLICATION = 'blog_drone.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Drone Club",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Drone Club Punta Alta",
